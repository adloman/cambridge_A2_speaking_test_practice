const questionBank = [
    ...
    { 
        ...
        options: [
            { text: "Yes, I have a dog named Max. He is very friendly. ", score: 100, feedback: "Great details and follow-up!" },
    ...
    { 
        ...
        options: [
            { text: "I ate some toast and drank orange juice. It was delicious! ", score: 100, feedback: "Perfect past tense and interaction." },
    ...
    { 
        ...
        options: [
            { text: "Yes, I love swimming in the ocean when the weather is hot. ", score: 100, feedback: "Great description!" },
    ...
    { 
        ...
        options: [
            { text: "I usually take the bus, but sometimes my dad drives me. ", score: 100, feedback: "Excellent use of frequency adverbs!" },
    ...
    { q: "6. Do you like learning English?", options: [
        { text: "Yes, I enjoy it because I want to travel to London. ", score: 100, feedback: "Good goal-setting and interaction!" },
    ...
    { q: "7. Who is your best friend?", options: [
        { text: "My best friend is Sara. She is very kind and funny.", score: 100, feedback: "Great adjectives!" },
    ...
    { q: "8. What is your favorite season?", options: [
        { text: "I love summer because I can go swimming and the days are long. ", score: 100, feedback: "Good linking words!" },
    ...
    { q: "9. Do you prefer reading books or watching TV?", options: [
        { text: "I prefer watching TV because I like action movies. ", score: 100, feedback: "Clear preference and follow-up." },
    ...
    { q: "10. What is your favorite food?", options: [
        { text: "I really love pizza with lots of cheese. What is your ", score: 100, feedback: "Great interaction!" },
    ...
    { q: "11. Tell me about your bedroom.", options: [
        { text: "It's a small room but it's very comfortable. I have a big desk. ", score: 100, feedback: "Great description!" },
    ...
    { q: "12. What do you do in the evenings?", options: [
        { text: "I usually do my homework and then I play video games. ", score: 100, feedback: "Good sequence of events." },
    ...
    { q: "14. How many people are there in your family?", options: [
        { text: "There are four people: my parents, my sister, and me. ", score: 100, feedback: "Perfect list and interaction." },
    ...
    { q: "15. What is the weather like today?", options: [
        { text: "It's sunny and quite warm today. ", score: 100, feedback: "Good use of 'quite' and interaction." },
    ...
    { q: "16. What are you going to do this weekend?", options: [
        { text: "I'm going to visit my grandparents on Saturday. ", score: 100, feedback: "Great future 'going to' usage." },
    ...
    { q: "17. Do you like sports?", options: [
        { text: "Yes, I love playing basketball because it's exciting. ", score: 100, feedback: "Perfect interaction!" },
    ...
    { q: "18. What subject do you like best at school?", options: [
        { text: "I like History best because I love learning about the past. ", score: 100, feedback: "Good reason and interaction." },
    ...
    { q: "19. Can you play a musical instrument?", options: [
        { text: "I can play the piano, but I am not very good yet. ", score: 100, feedback: "Honest and interactive." },
    ...
    { q: "20. What time do you usually wake up?", options: [
        { text: "I usually wake up at seven o'clock on school days. ", score: 100, feedback: "Great use of 'usually'!" },
    ...
    { q: "22. What did you do yesterday afternoon?", options: [
        { text: "I played football with my friends and then I did my homework. ", score: 100, feedback: "Perfect past tense sequence!" },
    ...
    { q: "23. Do you prefer summer or winter?", options: [
        { text: "I prefer summer because I love the sun and the beach. ", score: 100, feedback: "Clear preference and follow-up." },
        { text: "I like the winter more better because it have the snow.", score: 0, feedback: "TRAP! 'More better' and 'it have' are errors." },
    ...
    { q: "24. Tell me about your house.", options: [
        { text: "I live in a modern flat with three bedrooms and a balcony. ", score: 100, feedback: "Good descriptive words!" },
    ...
    { q: "25. What is your favorite animal?", options: [
        { text: "I love cats because they are very independent and cute. ", score: 100, feedback: "Great vocabulary!" },
    ...
    { q: "27. What do you usually do on your birthday?", options: [
        { text: "I usually have a party with my friends and eat cake. ", score: 100, feedback: "Great interaction!" },
    ...
    { q: "29. What is your favorite drink?", options: [
        { text: "I really like orange juice, especially in the morning. ", score: 100, feedback: "Great detail!" },
    ...
    { q: "30. What did you do last weekend?", options: [
        { text: "I went to the park and then I visited my cousins. ?", score: 100, feedback: "Perfect past tense interaction!" },
    ...
    { q: "31. Do you live in a house or a flat?", options: [
        { text: "I live in a flat on the third floor of a big building. ", score: 100, feedback: "Great preposition use!" },
    ...
    { q: "32. What is your favorite movie?", options: [
        { text: "My favorite movie is Harry Potter because I love magic. ", score: 100, feedback: "Good reason and interaction!" },
    ...
    { q: "34. Who is your favorite singer?", options: [
        { text: "I really like Taylor Swift because her songs are very beautiful.", score: 100, feedback: "Perfect interaction!" },
    ...
    { q: "35. What is the best place in your city?", options: [
        { text: "The central park is the best place because it's very quiet. ", score: 100, feedback: "Good superlative and follow-up." },
    ...
    { q: "36. Do you have any brothers or sisters?", options: [
        { text: "Yes, I have one older brother and two younger sisters. ", score: 100, feedback: "Excellent use of 'older/younger'!" },
    ...
    { q: "37. What is your favorite day of the week?", options: [
        { text: "I love Saturday because I can stay in bed until late. ", score: 100, feedback: "Great reason!" },
    ...
    { q: "38. Do you like cameras and taking photos?", options: [
        { text: "Yes, I take lots of photos with my phone to remember holidays. ", score: 100, feedback: "Good purpose and interaction." },
    ...
    { q: "39. What are you wearing today?", options: [
        { text: "I'm wearing a blue sweater, black trousers, and sneakers. ", score: 100, feedback: "Great vocabulary for clothes!" },
    ...
    { q: "40. Is your school big or small?", options: [
        { text: "My school is quite big; there are about five hundred students. ", score: 100, feedback: "Good use of 'quite' and numbers!" },
    ...
    { q: "43. Do you like computers?", options: [
        { text: "Yes, I use my computer for schoolwork and playing games. ", score: 100, feedback: "Good uses and follow-up." },
    ...
    { q: "44. What time does your school start?", options: [
        { text: "My school starts at half past eight every morning. ", score: 100, feedback: "Great time phrase!" },
    ...
    { q: "45. Tell me about your teacher.", options: [
        { text: "My teacher is very helpful and explains things clearly. ", score: 100, feedback: "Great adjectives and interaction." },
    ...
    { q: "46. What is your favorite hobby?", options: [
        { text: "I love drawing because it's very relaxing. ", score: 100, feedback: "Good reason and interaction!" },
    ...
    { q: "47. Do you like healthy food?", options: [
        { text: "Yes, I eat a lot of fruit and vegetables every day. ", score: 100, feedback: "Great examples and follow-up." },
    ...
    { q: "50. Is it a good idea to travel alone?", options: [
        { text: "Traveling with friends is more fun, but alone is good for learning. ", score: 100, feedback: "Good contrast and interaction." },
